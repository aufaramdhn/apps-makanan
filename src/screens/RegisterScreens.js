  ...
  return (
    <View style={{flex: 1, flexDirection:'column', backgroundColor: COLORS.primary}}>
      ...
      <Animatable.View animation="fadeInUpBig" style={styles.containerRegister}>
          ...
          <View style={styles.Login}>
            <Icon name="ri-lock-password-line" size="28" color={COLORS.secondary} />
            <TextInput placeholder='Confirm Your Password' secureTextEntry={true} style={styles.input}/>
          </View>
          ...
          <View style={{height: 2, backgroundColor: COLORS.secondary, marginLeft: 5, marginRight: 5, marginTop: 8}}/>
          <TouchableOpacity onPress={() => navigation.goBack()}>
